...
> **Status:** In development. All core features are functional with GitHub OAuth authentication. Production deployment (Firestore, Cloud Run) is not yet configured.
