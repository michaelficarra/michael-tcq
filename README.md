...
- **Saved topics** — a ♻️ button beside the entry-type buttons opens a dropdown of your saved queue topics. Click one and it's posted to the queue immediately as a new topic — ideal for short acknowledgements like "👍 I support this. (EOM)". Up to five topics can be saved per user (stored locally per GitHub account).
