...
- **Canned responses** — a 📝 button beside the entry-type buttons opens a dropdown of your saved canned queue topics. Click one and it's posted to the queue immediately as a new topic — ideal for short acknowledgements like "👍 I support this. (EOM)". Up to five canned responses can be saved per user (stored locally per GitHub account).
