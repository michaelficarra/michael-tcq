...
const ENTRY_TYPES: {
...
}[] = [
  {
    ...
    bgClass: 'bg-blue-500 enabled:hover:bg-blue-600',
    requiresTopic: false,
  },
  {
    type: 'reply',
    ...
    placeholder: 'Reply',
    bgClass: 'bg-cyan-500 enabled:hover:bg-cyan-600',
    requiresTopic: true,
  },
  {
    type: 'question',
    ...
    bgClass: 'bg-green-500 enabled:hover:bg-green-600',
    requiresTopic: false,
  },
  {
    type: 'point-of-order',
    ...
    bgClass: 'bg-rose-500 enabled:hover:bg-rose-600',
    requiresTopic: false,
  },
];
